...
const {BO} = require('../../../selectors/BO/index');
...
scenario('Create "Customer"', () => {
  ...
  scenario('Create a new "Customer"', client => {
    ...
    test('should set the "Birthday" input', () => client.setBirthday(Customer));
  ...
  scenario('Check the customer creation', client => {
    test('should check the existence of the customer filter name input', () => client.testElementVisibility(Customer.customer_filter_by_name_input));
