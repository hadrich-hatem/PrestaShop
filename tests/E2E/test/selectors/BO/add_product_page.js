module.exports = {
  AddProductPage: {
    ...
    red_validation_notice: '//*[@id="growls-default"]//div[@class="growl-message"]',
    ...
    picture_background_url: '(//*[contains(@class,"dz-preview") and not(contains(@class,"disable"))]/div)[%POS]',
    picture_legend_textarea_en: '//*[@id="form_image_legend_1"]',
    ...
    picture_dropzone_element: '#product-images-dropzone',
    ...
    picture_legend_textarea_fr: '//*[@id="form_image_legend_2"]',
    ...
    delete_combinations_button: '//*[@id="delete-combinations"]',
    ...
    delivery_time_radio_button: '//*[@id="form_step4_additional_delivery_times_%I"]',
    ...
    combination_size: '//*[@id="attribute-group-1"]//label[@for="attribute-%I"]',
    ...
    combination_color: '//*[@id="attribute-group-2"]//label[@for="attribute-%I"]',
    ...
    combination_final_retail_price: '//*[@id="combination_form_%NUMBER"]//span[contains(@class, "final-price")]',
    ...
    specific_price_delete_icon: '//*[@id="js-specific-price-list"]//i[text()="delete"]',
    ...
    get combination_name() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(3)'
    },
    get combination_price_input() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(4) > div > input'
    },
    get combination_final_price() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(5) > span'
    },
    get combination_quantity_input() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(6) > div > input'
    },
    get combination_edit_button() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(7) > div > a'
    },
    get combination_delete_button() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(8) > a'
    },
    get default_combination_radio_button() {
      return this.combination_table + ' > tr:nth-child(1) > td:nth-child(9) > input'
    },
