...
module.exports = {
  ...
  checkTinyMceButtons(client, id) {
    ...
    test('should check the existence of "Color picker" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 2)));
    test('should check the existence of "Bold" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 3)));
    test('should check the existence of "Italic" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 4)));
    test('should check the existence of "Underline" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 5)));
    test('should check the existence of "Strikethrough" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 6)));
    test('should check the existence of "Blockquote" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 7)));
    test('should check the existence of "Insert/edit link" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 8)));
    test('should check the existence of "Text format" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 9)));
    test('should check the existence of "Bullet list" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 10)));
    test('should check the existence of "Numbered list" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 11)));
    test('should check the existence of "Table" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 12)));
    test('should check the existence of "Insert/edit image" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 13)));
    test('should check the existence of "Insert/edit video" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 14)));
    test('should check the existence of "Presentation" button', () => client.isExisting(AddProductPage.tinymce_buttons.replace('%ID', id + 15)));
  },
