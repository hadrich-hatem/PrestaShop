...
scenario('Create pack product in the Back Office', () => {
  ...
  commonScenarios.getProductQuantity(data.pack.pack.pack1.search, "firstQuantity");
  commonScenarios.getProductQuantity(data.pack.pack.pack2.search, "secondQuantity");
  ...
  scenario('Fill "Basic settings" form', client => {
    ...
    test('should set the "product name" input', () => client.waitAndSetValue(AddProductPage.product_name_input, data.pack.name + date_time));
    test('should select the "Pack of products" type', () => client.waitAndSelectByValue(AddProductPage.product_type, 1));
    test('should check that the "Combinations" does not exist', () => client.checkIsNotVisible(AddProductPage.product_combinations, 2000));
    ...
    test('should click on "Delete" button from the list of products for this pack', () => {
      return promise
        .then(() => client.scrollTo(AddProductPage.quantity_shortcut_input))
        .then(() => client.moveToObject(AddProductPage.product_pack_delete_button.replace('%I', 3)))
        .then(() => client.waitForVisibleAndClick(AddProductPage.product_pack_delete_button.replace('%I', 3)));
    });
    ...
    commonScenarios.clickOnCoverAndSave(client);
    test('should set the "Legend picture" input', () => client.waitAndSetValue(AddProductPage.picture_legend_textarea_en, data.pack.name, 3000));
    ...
    test('should set the "Legend picture" input', () => client.waitAndSetValue(AddProductPage.picture_legend_textarea_en, "Second picture"));
    ...
    test('should check that the "Product pictures" is well ordered', () => {
      return promise
        ...
        .then(() => client.checkAttributeValue(productPage.product_pictures.replace('%ID', 2).replace('%LEGEND', data.pack.name), 'title', data.pack.name));
    });
    ...
    test('should click on "Yes" modal button', () => client.waitForVisibleAndClick(AddProductPage.delete_confirmation_button.replace('%BUTTON', 'Yes')));
    test('should check that the "Product picture" is well deleted', () => client.checkAttributeValue(AddProductPage.picture_background.replace('%POS', 1), 'data-id', tab['secondProductId'], 'notequal', 3000));
    ...
    test('should check that the success alert message is well displayed', () => client.waitForExistAndClick(AddProductPage.close_validation_button));
    test('should go to the Front Office', () => client.switchWindow(1));
    test('should check the existence of the first related product', () => client.isExisting(productPage.related_product.replace('%I', 1).replace('%S', 'mug'), 1000));
    test('should check the existence of the second related product', () => client.isExisting(productPage.related_product.replace('%I', 2).replace('%S', 'mug'), 1000));
    test('should check the existence of the third related product', () => client.isExisting(productPage.related_product.replace('%I', 3).replace('%S', 'mug'), 1000));
    test('should go back to the Back Office', () => client.switchWindow(0));
    ...
    test('should set the "New category name" input', () => client.waitAndSetValue(AddProductPage.product_category_name_input, data.pack.new_category_name + date_time));
    ...
    test('should check that the "Category" is well created', () => client.isExisting(AddProductPage.category_checkbox.replace('%S', data.pack.new_category_name + date_time), 4000));
    test('should click on "Save" button', () => client.waitForExistAndClick(AddProductPage.save_product_button, 3000));
    ...
    test('should check that the tree of categories is well closed', () => client.checkIsNotVisible(AddProductPage.category_clothes_label));
    ...
    test('should check the path of the created category is well displayed', () => client.checkAttributeValue(AddProductPage.category_name_span.replace('%I', 2), 'title', 'Home > ' + tab['parentCategoryName'] + ' > ' + data.pack.new_category_name + date_time));
  ...
  scenario('Fill "Quantities" form', client => {
    ...
    scenario('Check the label when the product out of stock', client => {
      test('should go to the Front Office', () => client.switchWindow(1));
      test('should check the existence of the label when the product is out of stock', () => client.checkTextValue(productPage.product_availability, 'product out of stock but orderable', 'contain', 3000));
      test('should go back to the Back Office', () => client.switchWindow(0));
    }, 'common_client');
    scenario('Check the behavior when out of stock', client => {
      ...
      test('should check that the success alert message is well displayed', () => client.waitForExistAndClick(AddProductPage.close_validation_button));
      test('should go to the Front Office', () => client.switchWindow(1));
      test('should check the existence of the label when the behavior is "Deny orders"', () => client.checkTextValue(productPage.product_availability, 'There are not enough products in stock', 'contain'));
      test('should go back to the Back Office', () => client.switchWindow(0));
  ...
  scenario('Fill "Pricing" form', client => {
    ...
    test('should go to the Front Office', () => client.switchWindow(1));
    test('should go to the home page', () => client.waitForExistAndClick(AccessPageFO.logo_home_page, 2000));
    ...
    test('should search for the product', () => client.searchByValue(SearchProductPage.search_input, SearchProductPage.search_button, data.pack.name + date_time));
    test('should check the existence of the product on sale flag', () => client.isExisting(productPage.product_on_sale_flag));
    ...
    test('should check the existence of the product on sale flag', () => {
      return promise
    ...
    test('should check the existence of "All currencies" select', () => client.isExisting(AddProductPage.specific_price_for_currency_select, 2000));
    test('should check the existence of "All countries" select', () => client.isExisting(AddProductPage.specific_price_for_country_select));
    test('should check the existence of "All groups" select', () => client.isExisting(AddProductPage.specific_price_for_group_select));
    test('should check the existence of "Customer" input', () => client.isExisting(AddProductPage.specific_price_customer_input));
    test('should check the existence of "Available from" calendar input', () => client.isExisting(AddProductPage.specific_price_available_from_input));
    test('should check the existence of "Available to" calendar input', () => client.isExisting(AddProductPage.specific_price_to_input));
    test('should check the existence of "Starting at" input', () => client.isExisting(AddProductPage.specific_price_starting_at_input));
    test('should check the existence of "Product price (tax excl.)"', () => client.isExisting(AddProductPage.specific_product_price_input));
    test('should check the existence of "Leave initial price" checkbox', () => client.isExisting(AddProductPage.leave_initial_price_checkbox));
    test('should check the existence of "Apply a discount of" input', () => client.isExisting(AddProductPage.specific_price_discount_input));
    test('should check the existence of "Discount type" select', () => client.isExisting(AddProductPage.specific_price_reduction_type_select));
    test('should check the existence of "Tax" select', () => client.isExisting(AddProductPage.specific_price_reduction_tax_select));
    ...
    test('should click on "Sign in" link', () => client.waitForExistAndClick(AccessPageFO.sign_in_button, 3000));
  ...
  scenario('Fill the SEO information form', client => {
    test('should click on "SEO" tab', () => client.scrollWaitForExistAndClick(AddProductPage.product_SEO_tab, 50, 2000));
  ...
  scenario('Fill the product options form', client => {
    ...
    test('should go to the Front Office', () => client.switchWindow(1));
    test('should click on the "Preview" link', () => client.waitForExistAndClick(AddProductPage.preview_link, 2000));
    test('should check that the product online only flag exist', () => client.isExisting(productPage.product_online_only_flag, 2000));
    test('should go back to the Back Office', () => client.switchWindow(0));
    ...
    test('should check that the success alert message is well displayed', () => client.waitForExistAndClick(AddProductPage.close_validation_button));
    test('should go to the Front Office', () => client.switchWindow(1));
    test('should check that the product online only flag does not exist', () => client.isNotExisting(productPage.product_online_only_flag, 20000));
    ...
    test('should check that the product is well displayed', () => client.isExisting(productPage.product_image.replace('%S', 'pk' + date_time)));
    test('should go to the "Home" page', () => client.waitForExistAndClick(AccessPageFO.logo_home_page));
    test('should search for the product', () => client.searchByValue(SearchProductPage.search_input, SearchProductPage.search_button, data.pack.name + date_time));
    ...
    test('should check that the product does not exist', () => client.isNotExisting(productPage.product_image.replace('%S', 'pk' + date_time)));
    test('should search for the product', () => client.searchByValue(SearchProductPage.search_input, SearchProductPage.search_button, data.pack.name + date_time));
    ...
    test('should go back to the Back Office', () => client.switchWindow(0));
    test('should click on "ATTACH A NEW FILE" button', () => client.scrollWaitForExistAndClick(AddProductPage.options_add_new_file_button, 50, 2000));
    test('should upload a picture', () => client.addFile(AddProductPage.options_select_file, 'image_test.jpg'), 50);
    test('should set the file "Title" input', () => client.waitAndSetValue(AddProductPage.options_file_name, 'title'));
    test('should set the file "Description" input', () => client.waitAndSetValue(AddProductPage.options_file_description, 'description'));
  ...
  //check that that quantity is well updated
  scenario('Check the products quantity', client => {
    test('should go back to the Back Office', () => client.switchWindow(0));
    test('should close the "Catalog" menu', () => client.waitForExistAndClick(Menu.Sell.Catalog.catalog_menu));
    test('should go to "Stock" page', () => client.clickAndOpenOnNewWindow(Menu.Sell.Catalog.catalog_menu, Menu.Sell.Catalog.stocks_submenu, 5));
    test('should search for the product', () => client.searchByValue(Stock.search_input, Stock.search_button, data.pack.name + date_time));
    test('should check that the pack product quantity is well decremented', () => client.checkTextValue(Stock.product_quantity.replace('%O', 1).replace('%I', 7), '98', 'equal', 2000));
  }, 'common_client');
  scenario('Change the default pack stock management', client => {
    test('should go to "Product settings" page', () => client.switchWindow(2));
    test('should select "Decrement products in pack only" of "Default pack stock management"', () => {
      return promise
        .then(() => client.scrollTo(ProductSettings.stockManagement_button))
        .then(() => client.waitAndSelectByValue(ProductSettings.stockManagement_button, 1));
    });
    test('should click on "Save" button', () => {
      return promise
        .then(() => client.isVisible(AddProductPage.symfony_toolbar, 3000))
  ...
  scenario('Create order in the Front Office', client => {
    ...
    test('should search for the product', () => client.searchByValue(SearchProductPage.search_input, SearchProductPage.search_button, data.pack.name + date_time));
    test('should go to the product page', () => client.waitForExistAndClick(SearchProductPage.product_result_name));
    test('should set the product "quantity" input', () => client.waitAndSetValue(productPage.first_product_quantity, "2"));
    test('should click on "Add to cart" button  ', () => client.waitForExistAndClick(CheckoutOrderPage.add_to_cart_button));
    test('should click on "Proceed to checkout" modal button', () => client.waitForVisibleAndClick(CheckoutOrderPage.proceed_to_checkout_modal_button));
    test('should click on "Proceed to checkout" button', () => client.waitForExistAndClick(CheckoutOrderPage.proceed_to_checkout_button));
    test('should click on "Confirm address" button', () => client.waitForExistAndClick(CheckoutOrderPage.checkout_step2_continue_button));
    test('should click on "confirm delivery" button', () => client.waitForExistAndClick(CheckoutOrderPage.checkout_step3_continue_button));
    test('should choose the payment type to "Payment by bank wire"', () => client.waitForExistAndClick(CheckoutOrderPage.checkout_step4_payment_radio));
    test('should click on "the condition to approve" checkbox', () => client.waitForExistAndClick(CheckoutOrderPage.condition_check_box));
    test('should click on "Order with an obligation to pay" button', () => client.waitForExistAndClick(CheckoutOrderPage.confirmation_order_button));
  }, 'common_client');
  //check that that quantity is well updated
  scenario('Check the products quantity', client => {
    test('should go back to the Back Office', () => client.switchWindow(5));
    test('should search for the product by name and dimension', () => {
      return promise
        .then(() => client.pause(3000))
        .then(() => client.searchByValue(Stock.search_input, Stock.search_button, data.pack.pack.pack1.search))
        .then(() => client.searchByValue(Stock.search_input, Stock.search_button, '40x60'))
    });
    test('should check that the pack product quantity is well decremented', () => {
      return promise
        .then(() => client.checkTextValue(Stock.product_quantity.replace('%O', 1).replace('%I', 7), (parseInt(tab["firstQuantity"]) - 2).toString(), 'equal', 5000))
        .then(() => client.refresh());
    });
    test('should search for the product by name and dimension', () => {
      return promise
        .then(() => client.pause(3000))
        .then(() => client.searchByValue(Stock.search_input, Stock.search_button, data.pack.pack.pack2.search))
        .then(() => client.searchByValue(Stock.search_input, Stock.search_button, '40x60'))
    });
    test('should check that the pack product quantity is well decremented', () => {
      return promise
        .then(() => client.checkTextValue(Stock.product_quantity.replace('%O', 1).replace('%I', 7), (parseInt(tab["secondQuantity"]) - 6).toString(), 'equal', 5000))
        .then(() => client.refresh());
    });
  }, 'common_client');
  scenario('Change the default pack stock management', client => {
    test('should go to "Product settings" page', () => client.switchWindow(2));
    test('should select "Decrement both" of "Default pack stock management"', () => {
      return promise
        .then(() => client.scrollTo(ProductSettings.stockManagement_button))
        .then(() => client.waitAndSelectByValue(ProductSettings.stockManagement_button, 2));
    });
    test('should click on "Save" button', () => {
      return promise
        .then(() => client.isVisible(AddProductPage.symfony_toolbar, 3000))
  ...
  scenario('Check the products quantity', client => {
    ...
    test('should check that the pack product quantity is well decremented', () => {
      return promise
        .then(() => client.checkTextValue(Stock.product_quantity.replace('%O', 1).replace('%I', 7), '96', 'equal', 2000))
        .then(() => client.refresh());
    });
    test('should search for the product by name and dimension', () => {
      return promise
    ...
    test('should check that the pack product quantity is well decremented', () => {
      return promise
        .then(() => client.checkTextValue(Stock.product_quantity.replace('%O', 1).replace('%I', 7), (parseInt(tab["firstQuantity"]) - 4).toString(), 'equal', 5000))
        .then(() => client.refresh());
    });
    test('should search for the product by name and dimension', () => {
      return promise
    ...
    test('should check that the pack product quantity is well decremented', () => {
      return promise
        .then(() => client.checkTextValue(Stock.product_quantity.replace('%O', 1).replace('%I', 7), (parseInt(tab["secondQuantity"]) - 12).toString(), 'equal', 5000))
        .then(() => client.refresh());
    });
  }, 'common_client');
  scenario('Disable the order of products out of stock', client => {
    ...
    test('should select "Decrement pack only" of "Default pack stock management"', () => {
      return promise
        .then(() => client.scrollTo(ProductSettings.stockManagement_button))
        .then(() => client.waitAndSelectByValue(ProductSettings.stockManagement_button, 0));
    });
  ...
  scenario('Delete the created "Currency"', client => {
    ...
    test('should click on "Delete" action from the dropdown list', () => client.waitForExistAndClick(Localization.Currency.delete_button));
