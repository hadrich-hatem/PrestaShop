...
scenario('Install "PrestaShop Security" module', () => {
  ...
  scenario('Install "PrestaShop Security" module by uploading a ZIP file', client => {
    ...
    test('should check if the module "prestafraud" was installed', () => client.checkTextValue(ModulePage.installed_module_div.replace('%moduleTechName', "prestafraud"), "1", "contain"));
  }, 'common_client');
