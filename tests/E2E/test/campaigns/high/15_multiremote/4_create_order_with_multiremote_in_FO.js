...
scenario('Create order in the Front Office', () => {
  ...
  scenario('Create order in the Front Office', client => {
    ...
    test('should search for the product "' + productData.name + date_time + '"', () => client.searchByValue(SearchProductPage.search_input, SearchProductPage.search_button, productData.name + '1519227218661'));
