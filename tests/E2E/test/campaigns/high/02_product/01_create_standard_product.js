...
scenario('Create Standard Product in the Back Office', client => {
  ...
  scenario('Edit Basic settings', client => {
    test('should set the "Name" input', () => client.waitAndSetValue(AddProductPage.product_name_input, data.standard.name + date_time));
    ...
    test('should upload the second product picture', () => client.uploadPicture('2.jpg', AddProductPage.picture));
    test('should set the "New category name" input', () => client.waitAndSetValue(AddProductPage.product_category_name_input, data.standard.new_category_name + date_time));
    ...
    test('should click on "ADD A FEATURE" button and select one', () => client.addFeatureHeight('standard'));
  ...
  scenario('Edit product shipping', client => {
    ...
    test('should click on "My carrier (Delivery next day!)" checkbox', () => client.scrollWaitForExistAndClick(AddProductPage.shipping_available_carriers.replace('%I', 1), 50));
  }, 'product/product');
  ...
  scenario('Edit SEO information', client => {
    ...
    test('should set the "Meta description" textarea', () => client.waitAndSetValue(AddProductPage.SEO_meta_description, data.common.metadesc));
  ...
  scenario('Edit product options', client => {
    ...
    test('should select the "Everywhere" visibility from the list', () => client.waitAndSelectByValue(AddProductPage.options_visibility, 'both'));
