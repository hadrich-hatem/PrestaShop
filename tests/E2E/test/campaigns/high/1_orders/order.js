...
module.exports = {
    createOrder: function (authentication = "connected") {
        scenario('Create order in the Front Office', client => {
            ...
            test('should click on proceed to checkout button 1', () => client.waitForVisibleAndClick(buyOrderPage.proceed_to_checkout_in_modal_button));
            test('should click on proceed to checkout button 2', () => client.waitForExistAndClick(buyOrderPage.proceed_to_checkout_button));
