...
class Product extends CommonClient {
    ...
    openAllCategory() {
        return this.client
            .scrollWaitForExistAndClick(AddProductPage.catalog_home, 50)
            ...
            .scrollWaitForExistAndClick(AddProductPage.catalog_third_element_radio, 50)
    }
    ...
    createCategory() {
        return this.client
            .scrollWaitForExistAndClick(AddProductPage.category_create_btn, 50)
            .pause(4000)
    }
    ...
    addFeatureHeight(type) {
        ...
        return this.client
            .scrollWaitForExistAndClick(AddProductPage.product_add_feature_btn, 150)
